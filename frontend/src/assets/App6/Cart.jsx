  ...
  return (
    <div>
      <div className='container mx-auto'>
                    ...
                    <div className='w-[95%] mx-auto justify-between items-center grid grid-cols-4'>
                      <div className='flex w-42.5 h-13.5 justify-between mx-auto'>
                        <div className='relative w-13.5 h-13.5 flex items-center justify-center group'>
                          ...
                          {item.image ? (
                            <img className='w-13.5 h-13.5 object-cover' src={item.image} alt={item.name} />
                          ) : (
                      ...
                      <div className='w-18 h-12 rounded-[4px] border-[1.5px] flex mx-auto'>
                        <div className='flex w-12 h-8 justify-between mx-auto mt-2'>
                          <p className='items-center mt-1 text-[17px]'>{item.count || 1}</p>
                      ...
                      <p className='text-[17px] mx-auto'>${(item.price * (item.count || 1)).toFixed(2)}</p>
                    </div>
                  </div>
                );
              })
        ...
        <div className='mt-5'>
          <Link to="/">
            <button className='w-54.5 h-14 border-2 flex float-left bg-white rounded-[8px] hover:bg-gray-50'>
              <p className='mx-auto items-center flex text-[17px]'>Return To Shop</p>
            </button>
          </Link>
          <button 
            onClick={clearCart}
            className='w-48.75 h-14 border-2 flex float-right bg-white rounded-[8px] hover:bg-gray-50'
          >
        ...
        <div className='flex justify-between container mx-auto mt-75'>
          <div className='h-14 w-131.75 justify-between flex'>
            <input 
              ...
              className='w-75 h-14 pl-2 pr-2 float-left border-2 rounded-[8px] text-[17px]'
            />
            <button className='h-14 w-52.75 float-right border-2 flex rounded-[8px] bg-red-800 hover:bg-red-900'>
